...
int main(int argc, char* argv[])
{
	...
	SemanticGP gp(param.pop_size, param.num_iter, param.max_height, param.tour_size, param.mut_rate, param.mut_step, param.mode_init, terminals, param.operators);
