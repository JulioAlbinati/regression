...
#include "gp/OptimizedCrossSGP.hpp"

using namespace std;

/*
*** Semantic GP with optimized crossover ***
*/
...
int main(int argc, char* argv[])
{
	...
	OptimizedCrossSGP gp(param.pop_size, param.num_iter, param.max_height, param.mut_height, param.tour_size, param.mut_rate, param.mut_step, param.mode_init, 
